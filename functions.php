 ...
 */
add_filter( 'query_loop_block_query_vars', frm_profile_callable( 'theme:query_loop_block_query_vars', function( $query, $block ) {
 ...
 */
add_filter( 'rest_article_query', frm_profile_callable( 'theme:rest_article_query', function( $args, $request ) {
