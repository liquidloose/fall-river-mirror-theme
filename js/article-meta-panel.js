        ...
        return wp.element.createElement(
            ...
            panelChildren.concat([
                wp.element.createElement('p', {
                    key: 'article-content-legacy-note'
                }, __('Article body is now edited directly in the canvas. `_article_content` is preserved as legacy data and is read-only here.', 'the-fall-river-mirror-clone')),
                wp.element.createElement(TextareaControl, {
                    key: 'article_content',
                    label: __('Legacy Content (_article_content)', 'the-fall-river-mirror-clone'),
                    value: (meta && meta._article_content) || '',
                    readOnly: true,
                    help: __('This field is no longer updated when editing article body blocks.', 'the-fall-river-mirror-clone'),
                    rows: 5
                }),
                /**
                 * COMMITTEE FIELD
