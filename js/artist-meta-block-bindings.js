/**
 * Block Bindings UI for Artist Meta Fields
 * 
 * This file adds a user interface in the Gutenberg block editor that allows users
 * to bind blocks (Paragraph, Heading, HTML) to artist meta fields. When a block
 * is bound, it will automatically display the value from the artist's meta field
 * on the frontend.
 * 
 * WHAT IT DOES:
 * - Adds a dropdown menu in the block settings sidebar when editing artist posts
 * - Allows selecting which artist meta field to bind to (email, website, etc.)
 ...
 * - Only appears when editing artist post types
 * 
 * USER FLOW:
 * 1. User edits an artist post
 * 2. User adds a Paragraph, Heading, or HTML block
 * 3. User opens block settings sidebar
 * 4. User sees "Artist Meta Binding" panel
 * 5. User selects a meta field from dropdown (e.g., "Email")
...
(function () {
    ...
    addFilter(
        'editor.BlockEdit',
        'fr-mirror/artist-meta-bindings',
        function(BlockEdit) {
            /**
            ...
            return function(props) {
                 ...
                 * 
                 * Only show binding controls when editing artist post types.
                 * If not an artist, return the original block component unchanged.
                 */
                ...
                const isBound = contentBinding?.source === 'fr-mirror/artist-meta';
                ...
                return el(
                    ...
                    el(
                        ...
                        el(
                            PanelBody,
                            {
                                title: __('Artist Meta Binding', 'fr-mirror'),
                                initialOpen: isBound
                            },
                            /**
                            ...
                            isBound && fieldKey ? el('div', {
                                ...
                                el('span', {}, 
                                    ...
                                    fieldKey === 'website' ? __('Website', 'fr-mirror') :
                                    fieldKey === 'instagram' ? __('Instagram', 'fr-mirror') :
                             ...
                             * 
                             * Dropdown menu that lets users select which artist meta field
                             * to bind this block to. Options include all available meta fields.
                             */
                            el(SelectControl, {
                                __nextHasNoMarginBottom: true,
                                label: __('Bind to Artist Meta', 'fr-mirror'),
                                ...
                                options: [
                                    ...
                                    { label: __('Website', 'fr-mirror'), value: 'website' },
                                    { label: __('Instagram', 'fr-mirror'), value: 'instagram' },
                                 ...
                                 * - Source: 'fr-mirror/artist-meta' (our custom binding source)
                                 * - Key: Which meta field to use (email, website, etc.)
                                 */
                                onChange: function(value) {
                                    ...
                                    if (value) {
                                         ...
                                         * 2. Store the source ('fr-mirror/artist-meta') and key (field name)
                                         * 3. Actual content will be fetched and displayed by useEffect hooks above
                                         */
                                        const newBinding = {
                                            source: 'fr-mirror/artist-meta',
                                            args: {
                                                key: value
                                            }
                                        };
